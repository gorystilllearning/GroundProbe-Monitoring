...
echo.
if exist "zabbix-liquid-glass.css" (
  type zabbix-liquid-glass.css | docker exec -u root -i groundprobe-zabbix-web sh -c "cat >> /usr/share/zabbix/assets/styles/dark-theme.css && cp /usr/share/zabbix/assets/styles/dark-theme.css /usr/share/zabbix/assets/styles/blue-theme.css"
  if %errorlevel% equ 0 (
